...
# Load the SST data (replace 'sst_image.jpg' with the actual file path)
...
# Approximate wind directions based on the angle_deg (you may need to define specific thresholds)
wind_directions = []
